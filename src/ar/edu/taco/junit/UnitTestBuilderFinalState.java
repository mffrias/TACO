...
public class UnitTestBuilderFinalState {
    ...
    public UnitTestBuilderFinalState(RecoveredInformation recoveredInformation/*, TacoAnalysisResult tacoAnalysisResult*/) {
...
//				}
                ...
                if (recoveredInformation.getSnapshot().get(THIZ_1) != null) //It may be null even if the method is not static in case the method does not use any
                    //attribute from this (Alloy will prune variable "thiz").
                    thizInstance = recoveredInformation.getSnapshot().get(THIZ_1);
                else {
