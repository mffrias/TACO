 ...
 *
 */
public class MI_JavaLangByte implements MethodInformationSupplier {
	...
	public ConcreteMethodInformation getInformationForMethod(String methodName) {
		...
		if ("valueOf".equals(methodName)) {
			...
			concreteMethodInformation.setReturnType(CStdType.Byte);
			concreteMethodInformation.setQualifiedReceiverType("java_lang_Byte");
		} else {
