 ...
 * 
 */
public class MI_JavaLangCharacter implements MethodInformationSupplier {
	@Override
	public ConcreteMethodInformation getInformationForMethod(String methodName) {
		...
		if ("valueOf".equals(methodName)) {
			...
			concreteMethodInformation.setReturnType(CStdType.Char);
			concreteMethodInformation.setQualifiedReceiverType("java_lang_Character");
