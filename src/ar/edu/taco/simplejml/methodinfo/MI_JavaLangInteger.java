 ...
 * 
 */
public class MI_JavaLangInteger implements MethodInformationSupplier {
	@Override
	public ConcreteMethodInformation getInformationForMethod(String methodName) {
		...
		if ("valueOf".equals(methodName)) {
			...
			concreteMethodInformation.setReturnType(CStdType.Integer);
			concreteMethodInformation.setQualifiedReceiverType("java_lang_Integer");
		} else {
