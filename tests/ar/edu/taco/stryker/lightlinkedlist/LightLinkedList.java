 ...
 */
package ar.edu.taco.stryker.lightlinkedlist;
...
public class LightLinkedList {
	 ...
	 */
	public transient /*@ nullable @*/ LinkedListNode header;
	/** The size of the list */
	protected transient int size;
	/** Modification count for iterators */
	protected transient int modCount;

	//@ public initially myseq != null && myseq.isEmpty(); 
	//@ public instance non_null JMLObjectSequence myseq;
	/*@ 
