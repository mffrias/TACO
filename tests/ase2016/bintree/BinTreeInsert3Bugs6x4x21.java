...
/**
* BinTreeInsert1Bug6 is an implementation of binary search trees with three bugs
* injected in lines 6 and 4 and 21 of method insert. First bug replaces:
* if (x.key > k) 
* with
* if (x.key < k) 
* Second bug replaces:
...
public class BinTreeInsert3Bugs6x4x21 {
    ...
    public BinTreeInsert3Bugs6x4x21() {
    }
