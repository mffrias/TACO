...
/**
* SinglyLinkedListInsertBack2Bugs11x10 is an implementation of singly linked lists with 2 bugs
* injected in lines 11 and 10 of method insertBack. First bug replaces:
* previous = current;
* with
* previous = null;
* Second bug replaces:
...
public class SinglyLinkedListInsertBack2Bugs11x10 {
    ...
    public SinglyLinkedListInsertBack2Bugs11x10() {
    }
