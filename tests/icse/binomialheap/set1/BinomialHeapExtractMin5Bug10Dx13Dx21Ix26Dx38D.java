...
public class BinomialHeapExtractMin5Bug10Dx13Dx21Ix26Dx38D {
    ...
    public BinomialHeapExtractMin5Bug10Dx13Dx21Ix26Dx38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        while (temp.key != minNode.key) { //mutGenLimit 0
            prevTemp = temp; //mutGenLimit 0
            temp = temp.sibling.parent; //mutGenLimit 1
        }
        if (prevTemp == null) { //mutGenLimit 0
            Nodes = temp.child; //mutGenLimit 1
        } else {
