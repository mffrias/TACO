...
public class BinomialHeapExtractMin6Bug8Dx10Dx15Ix17Dx18Dx21D {
    ...
    public BinomialHeapExtractMin6Bug8Dx10Dx15Ix17Dx18Dx21D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        while (temp.key != minNode.key--) { //mutGenLimit 1
            prevTemp = temp; //mutGenLimit 0
            temp = temp.parent.sibling; //mutGenLimit 1
        }
        if (prevTemp == null) { //mutGenLimit 0
        ...
        while (temp != null) { //mutGenLimit 0
            ...
            temp = minNode.sibling; //mutGenLimit 1
        }
