...
public class BinomialHeapFindMinimum4Bug2Dx4Dx9Dx11D {
    ...
    public BinomialHeapFindMinimum4Bug2Dx4Dx9Dx11D() {
    }
    ...
    public int findMinimum() {
        ...
        icse.binomialheap.BinomialHeapNode y = this.Nodes.sibling; //mutGenLimit 1
        int min = x.key; //mutGenLimit 0
        //@decreasing \reach(x, BinomialHeapNode, sibling).int_size();
        while (x != this.Nodes) { //mutGenLimit 1
            if (x.key < min) { //mutGenLimit 0
                y = x; //mutGenLimit 0
                min = x.key; //mutGenLimit 0
            }
            x = x.child.sibling; //mutGenLimit 1
        }
        return this.Nodes.key; //mutGenLimit 1
    }
