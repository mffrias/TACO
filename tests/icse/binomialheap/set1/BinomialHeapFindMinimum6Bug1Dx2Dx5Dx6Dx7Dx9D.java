...
public class BinomialHeapFindMinimum6Bug1Dx2Dx5Dx6Dx7Dx9D {
    ...
    public BinomialHeapFindMinimum6Bug1Dx2Dx5Dx6Dx7Dx9D() {
    }
    ...
    public int findMinimum() {
        ...
        while (x != null) { //mutGenLimit 0
            if (x.key >= min) { //mutGenLimit 1
                y = x.findMinNode(); //mutGenLimit 1
                min = x.findMinNode().key; //mutGenLimit 1
            }
            x = x.findMinNode(); //mutGenLimit 1
        }
