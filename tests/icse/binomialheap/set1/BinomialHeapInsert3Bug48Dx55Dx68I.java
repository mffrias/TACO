...
public class BinomialHeapInsert3Bug48Dx55Dx68I {
    ...
    public BinomialHeapInsert3Bug48Dx55Dx68I() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = insertTemp.sibling; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 0
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            temp.sibling = this.Nodes.sibling; //mutGenLimit 1
                            ...
                            prevTemp.child = temp; //mutGenLimit 1
