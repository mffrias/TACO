...
public class BinomialHeapInsert4Bug13Dx30Ix32Ix50D {
    ...
    public BinomialHeapInsert4Bug13Dx30Ix32Ix50D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        temp2 = temp1.sibling; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.parent.sibling.degree == temp.degree) { //mutGenLimit 1
