...
public class BinomialHeapExtractMin4Bug7Dx13Ix23Dx38D {
    ...
    public BinomialHeapExtractMin4Bug7Dx13Ix23Dx38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode = Nodes.child; //mutGenLimit 1
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        ...
        if (Nodes == null && fakeNode == fakeNode) { //mutGenLimit 1
        ...
        return minNode.findMinNode(); //mutGenLimit 1
    }
