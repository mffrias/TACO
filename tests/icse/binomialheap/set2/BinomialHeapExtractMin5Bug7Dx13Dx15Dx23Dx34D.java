...
public class BinomialHeapExtractMin5Bug7Dx13Dx15Dx23Dx34D {
    ...
    public BinomialHeapExtractMin5Bug7Dx13Dx15Dx23Dx34D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode = this.Nodes.sibling.findMinNode(); //mutGenLimit 1
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        ...
        if (prevTemp == null) { //mutGenLimit 0
            Nodes = temp; //mutGenLimit 1
        } else {
            prevTemp.sibling = temp.sibling.findMinNode(); //mutGenLimit 1
        }
