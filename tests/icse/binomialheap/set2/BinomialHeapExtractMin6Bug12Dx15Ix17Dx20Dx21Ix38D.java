...
public class BinomialHeapExtractMin6Bug12Dx15Ix17Dx20Dx21Ix38D {
    ...
    public BinomialHeapExtractMin6Bug12Dx15Ix17Dx20Dx21Ix38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (prevTemp == prevTemp) { //mutGenLimit 1
            Nodes = temp.sibling; //mutGenLimit 0
        } else {
            prevTemp.parent = temp.sibling; //mutGenLimit 1
        }
        temp = temp.child.sibling; //mutGenLimit 1
        icse.binomialheap.BinomialHeapNode fakeNode = temp; //mutGenLimit 0
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp != null) { //mutGenLimit 0
            temp.parent = fakeNode; //mutGenLimit 1
            temp.sibling = temp.sibling; //mutGenLimit 1
        }
        ...
        return this.Nodes; //mutGenLimit 1
    }
