...
public class BinomialHeapFindMinimum5Bug1Dx3Dx5Dx6Dx9I {
    ...
    public BinomialHeapFindMinimum5Bug1Dx3Dx5Dx6Dx9I() {
    }
    ...
    public int findMinimum() {
        icse.binomialheap.BinomialHeapNode x = null; //mutGenLimit 1
        ...
        while (x != null) { //mutGenLimit 0
            if (y.key < min) { //mutGenLimit 1
                y = this.extractMin(); //mutGenLimit 1
                min = x.key; //mutGenLimit 0
            }
            x.sibling = x.sibling; //mutGenLimit 1
        }
