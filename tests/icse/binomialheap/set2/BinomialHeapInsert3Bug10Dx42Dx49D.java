...
public class BinomialHeapInsert3Bug10Dx42Dx49D {
    ...
    public BinomialHeapInsert3Bug10Dx42Dx49D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != this.Nodes && temp2 != null) { //mutGenLimit 1
                ...
                while (nextTemp != insertTemp) { //mutGenLimit 1
