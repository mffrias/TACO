...
public class BinomialHeapInsert6Bug20Dx30Dx50Dx54Dx66Dx73D {
    ...
    public BinomialHeapInsert6Bug20Dx30Dx50Dx54Dx66Dx73D() {
    }
        ...
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.sibling.degree > temp2.degree) { //mutGenLimit 0
                                icse.binomialheap.BinomialHeapNode tmp = null; //mutGenLimit 1
                                temp2 = temp2.sibling; //mutGenLimit 0
                                tmp.sibling = temp1.sibling; //mutGenLimit 0
                                temp1.sibling = tmp; //mutGenLimit 0
                                temp1 = tmp.sibling; //mutGenLimit 0
                            ...
                            temp1 = temp2.findMinNode(); //mutGenLimit 1
                            temp2 = temp2.sibling; //mutGenLimit 0
                            temp1.sibling = tmp; //mutGenLimit 0
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.findMinNode().sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        prevTemp = temp; //mutGenLimit 0
                        temp = nextTemp; //mutGenLimit 0
                    } else {
                        if (temp.findMinNode().key <= nextTemp.key) { //mutGenLimit 1
                            ...
                            temp.parent = nextTemp.findMinNode(); //mutGenLimit 1
                    ...
                    nextTemp = this.Nodes.sibling; //mutGenLimit 1
                }
                size++; //mutGenLimit 0
            }
        }
