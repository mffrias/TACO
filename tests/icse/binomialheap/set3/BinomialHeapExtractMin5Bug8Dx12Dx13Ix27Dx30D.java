...
public class BinomialHeapExtractMin5Bug8Dx12Dx13Ix27Dx30D {
    ...
    public BinomialHeapExtractMin5Bug8Dx12Dx13Ix27Dx30D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp.key != this.Nodes.key) { //mutGenLimit 1
            prevTemp = temp; //mutGenLimit 0
        ...
        if (Nodes == null && fakeNode == null) { //mutGenLimit 0
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                Nodes = fakeNode.parent; //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && null == null) { //mutGenLimit 1
                    size--; //mutGenLimit 0
                } else {
