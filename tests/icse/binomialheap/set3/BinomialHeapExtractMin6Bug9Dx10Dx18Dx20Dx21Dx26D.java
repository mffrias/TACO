...
public class BinomialHeapExtractMin6Bug9Dx10Dx18Dx20Dx21Dx26D {
    ...
    public BinomialHeapExtractMin6Bug9Dx10Dx18Dx20Dx21Dx26D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        while (temp.key != minNode.key) { //mutGenLimit 0
            prevTemp = this.Nodes; //mutGenLimit 1
        ...
        icse.binomialheap.BinomialHeapNode fakeNode = temp.sibling; //mutGenLimit 1
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp != null) { //mutGenLimit 0
            temp.parent = fakeNode; //mutGenLimit 1
            temp = fakeNode.sibling; //mutGenLimit 1
        }
        if (Nodes == null && fakeNode == null) { //mutGenLimit 0
            size = 0; //mutGenLimit 0
        } else {
            if (Nodes == null && fakeNode != temp) { //mutGenLimit 1
