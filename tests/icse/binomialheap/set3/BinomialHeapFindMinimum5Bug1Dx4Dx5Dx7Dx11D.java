...
public class BinomialHeapFindMinimum5Bug1Dx4Dx5Dx7Dx11D {
    ...
    public BinomialHeapFindMinimum5Bug1Dx4Dx5Dx7Dx11D() {
    }
    ...
    public int findMinimum() {
        ...
        while (x != x) { //mutGenLimit 1
            if (x.key > min) { //mutGenLimit 1
                y = x; //mutGenLimit 0
                min = x.child.key; //mutGenLimit 1
            }
