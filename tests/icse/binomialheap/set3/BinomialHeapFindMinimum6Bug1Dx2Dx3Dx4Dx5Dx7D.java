...
public class BinomialHeapFindMinimum6Bug1Dx2Dx3Dx4Dx5Dx7D {
    ...
    public BinomialHeapFindMinimum6Bug1Dx2Dx3Dx4Dx5Dx7D() {
    }
    ...
    public int findMinimum() {
        icse.binomialheap.BinomialHeapNode x = this.Nodes.parent; //mutGenLimit 1
        icse.binomialheap.BinomialHeapNode y = this.Nodes; //mutGenLimit 1
        int min = y.key; //mutGenLimit 1
        //@decreasing \reach(x, BinomialHeapNode, sibling).int_size();
        while (x != this.extractMin()) { //mutGenLimit 1
            if (x.key < min--) { //mutGenLimit 1
                y = x; //mutGenLimit 0
                min = x.degree; //mutGenLimit 1
            }
