...
public class BinomialHeapInsert4Bug5Dx8Dx26Ix50D {
    ...
    public BinomialHeapInsert4Bug5Dx8Dx26Ix50D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                Nodes = insertTemp.sibling; //mutGenLimit 1
                size = 1; //mutGenLimit 0
            } else {
                icse.binomialheap.BinomialHeapNode temp1 = insertTemp; //mutGenLimit 1
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.sibling.degree > temp2.degree) { //mutGenLimit 0
                                ...
                                temp1.child = temp1.sibling; //mutGenLimit 1
                            }
                        } else {
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.child.degree == temp.degree) { //mutGenLimit 1
