...
public class BinomialHeapInsert5Bug19Dx23Ix24Ix26Dx31D {
    ...
    public BinomialHeapInsert5Bug19Dx23Ix24Ix26Dx31D() {
    }
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.sibling.degree <= temp2.degree) { //mutGenLimit 1
                                ...
                                temp1.sibling = tmp.sibling; //mutGenLimit 1
                            } else {
                                temp1 = temp1.child.sibling; //mutGenLimit 1
                            }
                        } else {
                            icse.binomialheap.BinomialHeapNode tmp = temp1; //mutGenLimit 0
                            temp1 = temp2; //mutGenLimit 0
                            temp2 = insertTemp.sibling; //mutGenLimit 1
                            temp1.sibling = tmp; //mutGenLimit 0
