...
public class BinomialHeapInsert6Bug3Dx13Ix19Dx26Ix50Dx58I {
    ...
    public BinomialHeapInsert6Bug3Dx13Ix19Dx26Ix50Dx58I() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            insertTemp.key = 0; //mutGenLimit 1
            if (Nodes == null) { //mutGenLimit 0
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.parent.degree > temp2.degree) { //mutGenLimit 1
                                ...
                                temp1.sibling = temp1.sibling; //mutGenLimit 1
                            }
                        } else {
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != nextTemp && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            temp.child.child = nextTemp; //mutGenLimit 1
