...
public class BinomialHeapExtractMin5Bug12Dx15Dx20Ix23Dx24I {
    ...
    public BinomialHeapExtractMin5Bug12Dx15Dx20Ix23Dx24I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (null == null) { //mutGenLimit 1
            ...
            prevTemp.sibling = temp.sibling.parent; //mutGenLimit 1
        }
        ...
        if (Nodes == this.extractMin() && fakeNode == null) { //mutGenLimit 1
            this.size = 0; //mutGenLimit 1
        } else {
