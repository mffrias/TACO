...
public class BinomialHeapExtractMin6Bug8Dx12Dx15Dx23Dx27Dx38D {
    ...
    public BinomialHeapExtractMin6Bug8Dx12Dx15Dx23Dx27Dx38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (prevTemp == this.Nodes) { //mutGenLimit 1
            Nodes = temp.sibling; //mutGenLimit 0
        } else {
            prevTemp.sibling = temp.child; //mutGenLimit 1
        }
        ...
        if (!(Nodes == null) && fakeNode == null) { //mutGenLimit 1
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                Nodes = fakeNode.sibling; //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && fakeNode == null) { //mutGenLimit 0
                    size--; //mutGenLimit 0
