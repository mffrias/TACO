...
public class BinomialHeapFindMinimum6Bug3Dx4Dx5Dx6Ix7Dx11D {
    ...
    public BinomialHeapFindMinimum6Bug3Dx4Dx5Dx6Ix7Dx11D() {
    }
    ...
    public int findMinimum() {
        ...
        while (x != y) { //mutGenLimit 1
            if (this.extractMin().key < min) { //mutGenLimit 1
                y.child = x; //mutGenLimit 1
                min = y.key; //mutGenLimit 1
            }
            x = x.sibling; //mutGenLimit 0
        }
        return this.extractMin().key; //mutGenLimit 1
    }
