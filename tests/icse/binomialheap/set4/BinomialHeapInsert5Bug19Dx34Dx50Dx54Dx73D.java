...
public class BinomialHeapInsert5Bug19Dx34Dx50Dx54Dx73D {
    ...
    public BinomialHeapInsert5Bug19Dx34Dx50Dx54Dx73D() {
    }
        ...
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            ...
                            if (tmp == Nodes) { //mutGenLimit 0
                                Nodes = temp1.child; //mutGenLimit 1
                            }
                        }
                    }
                }
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.parent.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        prevTemp = temp; //mutGenLimit 0
                        temp = nextTemp; //mutGenLimit 0
                    } else {
                        if (this.Nodes.key <= nextTemp.key) { //mutGenLimit 1
                    ...
                    nextTemp = temp.sibling.parent; //mutGenLimit 1
                }
                size++; //mutGenLimit 0
            }
        }
