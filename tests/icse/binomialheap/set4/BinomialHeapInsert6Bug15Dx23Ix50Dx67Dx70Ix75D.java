...
public class BinomialHeapInsert6Bug15Dx23Ix50Dx67Dx70Ix75D {
    ...
    public BinomialHeapInsert6Bug15Dx23Ix50Dx67Dx70Ix75D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        temp1.sibling = tmp.parent; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && insertTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            temp.sibling = nextTemp.findMinNode().child; //mutGenLimit 1
                            nextTemp.child = temp; //mutGenLimit 0
                            nextTemp.degree++; //mutGenLimit 0
                            insertTemp = nextTemp; //mutGenLimit 1
                        }
                    }
