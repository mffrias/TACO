...
public class BinomialHeapExtractMin4Bug8Dx9Ix15Ix17I {
    ...
    public BinomialHeapExtractMin4Bug8Dx9Ix15Ix17I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (prevTemp.key != minNode.key) { //mutGenLimit 1
            prevTemp.sibling = temp; //mutGenLimit 1
            temp = temp.sibling; //mutGenLimit 0
        }
        if (prevTemp == null) { //mutGenLimit 0
            Nodes = temp.sibling; //mutGenLimit 0
        } else {
            this.Nodes.sibling = temp.sibling; //mutGenLimit 1
        }
        minNode = temp.child; //mutGenLimit 1
