...
public class BinomialHeapExtractMin6Bug9Dx10Ix12Dx18Dx21Dx30D {
    ...
    public BinomialHeapExtractMin6Bug9Dx10Ix12Dx18Dx21Dx30D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        while (temp.key != minNode.key) { //mutGenLimit 0
            prevTemp = this.extractMin(); //mutGenLimit 1
            prevTemp = temp.sibling; //mutGenLimit 1
        }
        ...
        icse.binomialheap.BinomialHeapNode fakeNode = null; //mutGenLimit 1
        //@decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp != null) { //mutGenLimit 0
            temp.parent = null; //mutGenLimit 0
            temp = temp.sibling.sibling; //mutGenLimit 1
        }
