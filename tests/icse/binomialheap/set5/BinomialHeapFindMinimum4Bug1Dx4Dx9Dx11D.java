...
public class BinomialHeapFindMinimum4Bug1Dx4Dx9Dx11D {
    ...
    public BinomialHeapFindMinimum4Bug1Dx4Dx9Dx11D() {
    }
    ...
    public int findMinimum() {
        icse.binomialheap.BinomialHeapNode x = this.Nodes.child; //mutGenLimit 1
        ...
        while (x != this.extractMin()) { //mutGenLimit 1
            ...
            x = y.sibling; //mutGenLimit 1
        }
        return y.findMinNode().key; //mutGenLimit 1
    }
