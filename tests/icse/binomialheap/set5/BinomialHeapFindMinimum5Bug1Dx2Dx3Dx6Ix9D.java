...
public class BinomialHeapFindMinimum5Bug1Dx2Dx3Dx6Ix9D {
    ...
    public BinomialHeapFindMinimum5Bug1Dx2Dx3Dx6Ix9D() {
    }
    ...
    public int findMinimum() {
        icse.binomialheap.BinomialHeapNode x = this.Nodes.sibling; //mutGenLimit 1
        icse.binomialheap.BinomialHeapNode y = this.Nodes.findMinNode(); //mutGenLimit 1
        int min = this.extractMin().key; //mutGenLimit 1
        ...
        while (x != null) { //mutGenLimit 0
            ...
            x = x.sibling.parent; //mutGenLimit 1
        }
