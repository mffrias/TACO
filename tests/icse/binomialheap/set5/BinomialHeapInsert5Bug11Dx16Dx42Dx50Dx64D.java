...
public class BinomialHeapInsert5Bug11Dx16Dx42Dx50Dx64D {
    ...
    public BinomialHeapInsert5Bug11Dx16Dx42Dx50Dx64D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (!(temp1.degree == temp2.degree)) { //mutGenLimit 1
                        ...
                        temp1 = temp2.sibling; //mutGenLimit 1
                    } else {
                ...
                if (temp1 == null) { //mutGenLimit 0
                    ...
                    while (temp1.sibling != null) { //mutGenLimit 0
                        temp1 = temp1.child; //mutGenLimit 1
                    }
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != this.Nodes.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            if (prevTemp == null) { //mutGenLimit 0
                                ...
                                prevTemp.sibling = temp1; //mutGenLimit 1
                            }
