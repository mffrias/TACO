...
public class BinTreeRemove5Bug12Dx15Dx31Dx34Ix40D {
    ...
    public BinTreeRemove5Bug12Dx15Dx31Dx34Ix40D() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == null) { //mutGenLimit 0
            ...
            if (node.left != null && node.right != null) { //mutGenLimit 0
                icse.bintree.BinTreeNode predecessor = node.right.left; //mutGenLimit 1
