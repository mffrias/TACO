...
public class BinTreeInsert5Bug5Dx8Dx9Ix20Dx21I {
    ...
    public BinTreeInsert5Bug5Dx8Dx9Ix20Dx21I() {
    }
    ...
    public boolean insert( int k, BinTreeNode newBinTreeNode ) {
        ...
        while (x != null) { //mutGenLimit 0
            y = x; //mutGenLimit 0
            if (this.size < x.key) { //mutGenLimit 1
                x = x.left; //mutGenLimit 0
            } else {
                if (k > x.right.key) { //mutGenLimit 1
                    x.left = x.right; //mutGenLimit 1
                } else {
                    return false; //mutGenLimit 0
                }
            }
