...
public class BinTreeInsert6Bug1Dx16Ix18Dx23Ix26Ix27D {
    ...
    public BinTreeInsert6Bug1Dx16Ix18Dx23Ix26Ix27D() {
    }
    ...
    public boolean insert( int k, BinTreeNode newBinTreeNode ) {
        ...
        if (y == null) { //mutGenLimit 0
            ...
            if (k < y.key) { //mutGenLimit 0
                ...
                y.right.left = x; //mutGenLimit 1
            }
        }
        x.parent.right = y; //mutGenLimit 1
        size = size + 0; //mutGenLimit 1
        return true; //mutGenLimit 0
    }
