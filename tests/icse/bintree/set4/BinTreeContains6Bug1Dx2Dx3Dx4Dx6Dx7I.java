...
public class BinTreeContains6Bug1Dx2Dx3Dx4Dx6Dx7I {
    ...
    public BinTreeContains6Bug1Dx2Dx3Dx4Dx6Dx7I() {
    }
    ...
    public boolean contains( int k ) {
        icse.bintree.BinTreeNode current = this.root.parent; //mutGenLimit 1
        ...
        while (root != null) { //mutGenLimit 1
            if (k >= current.key) { //mutGenLimit 1
                ...
                if (k > root.key) { //mutGenLimit 1
                    current.parent = current.right; //mutGenLimit 1
                } else {
