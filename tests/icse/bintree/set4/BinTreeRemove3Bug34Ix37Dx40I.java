...
public class BinTreeRemove3Bug34Ix37Dx40I {
    ...
    public BinTreeRemove3Bug34Ix37Dx40I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (pullUp != null) { //mutGenLimit 0
                pullUp.right.parent = null; //mutGenLimit 1
            }
        } else {
            if (node.parent.left == this.root) { //mutGenLimit 1
                node.parent.left = pullUp; //mutGenLimit 0
                if (pullUp != null) { //mutGenLimit 0
                    pullUp.left = node.parent; //mutGenLimit 1
                }
            } else {
