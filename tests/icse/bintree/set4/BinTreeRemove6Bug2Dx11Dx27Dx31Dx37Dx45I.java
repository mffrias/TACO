...
public class BinTreeRemove6Bug2Dx11Dx27Dx31Dx37Dx45I {
    ...
    public BinTreeRemove6Bug2Dx11Dx27Dx31Dx37Dx45I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node.left == null) { //mutGenLimit 0
            pullUp = node.parent.right; //mutGenLimit 1
        } else {
        ...
        if (node != root) { //mutGenLimit 1
            ...
            if (pullUp.parent.left == node) { //mutGenLimit 1
