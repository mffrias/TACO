...
public class BinTreeContains3Bug1Dx4Dx7I {
    ...
    public BinTreeContains3Bug1Dx4Dx7I() {
    }
    ...
    public boolean contains( int k ) {
        icse.bintree.BinTreeNode current = this.root.left; //mutGenLimit 1
        //@decreasing \reach(current, BinTreeNode, left+right).int_size();
        while (current != null) { //mutGenLimit 0
            if (k < current.key) { //mutGenLimit 0
                current = current.right.left; //mutGenLimit 1
            } else {
                if (k > current.key) { //mutGenLimit 0
                    current.right = current.right; //mutGenLimit 1
                } else {
