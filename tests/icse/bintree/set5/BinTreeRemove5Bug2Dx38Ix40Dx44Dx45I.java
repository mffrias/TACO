...
public class BinTreeRemove5Bug2Dx38Ix40Dx44Dx45I {
    ...
    public BinTreeRemove5Bug2Dx38Ix40Dx44Dx45I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (node.parent.left == node) { //mutGenLimit 0
                node.parent.right.left = pullUp; //mutGenLimit 1
                if (pullUp != null) { //mutGenLimit 0
                    pullUp.parent = node.parent.left; //mutGenLimit 1
                }
            } else {
                node.parent.right = pullUp; //mutGenLimit 0
                if (pullUp != this.root) { //mutGenLimit 1
                    pullUp.parent.left = node.parent; //mutGenLimit 1
                }
            }
        }
