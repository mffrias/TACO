...
public class BinTreeRemove6Bug2Dx4Dx21Dx34Ix37Dx44D {
    ...
    public BinTreeRemove6Bug2Dx4Dx21Dx34Ix37Dx44D() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == null) { //mutGenLimit 0
            ...
            if (node.left != null && node.right != null) { //mutGenLimit 0
                ...
                node.key = predecessor.right.key; //mutGenLimit 1
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (pullUp != null) { //mutGenLimit 0
                pullUp.left.parent = null; //mutGenLimit 1
            }
        } else {
