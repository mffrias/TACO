...
/**
 * @j2daType
 *//*@ nullable_by_default @*/public class NodeCachingLinkedListMEALSDemo {
     ...
     public NodeCachingLinkedListMEALSDemo() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
    	LinkedListNode node = null; //mutGenLimit 0
	...
	/*@ 
	  ...
	  public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
	      icse.nodecachinglinkedlist.LinkedListNode node = header.next; //mutGenLimit 1
