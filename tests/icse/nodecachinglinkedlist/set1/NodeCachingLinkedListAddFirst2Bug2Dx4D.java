...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst2Bug2Dx4D {
    ...
    public NodeCachingLinkedListAddFirst2Bug2Dx4D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        newNode.value = new java.lang.Boolean( false ); //mutGenLimit 1
