...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst3Bug5Dx6Ix10D {
    ...
    public NodeCachingLinkedListAddFirst3Bug5Dx6Ix10D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        ...
        newNode.previous = newNode.previous; //mutGenLimit 1
        insertBeforeNode.previous.previous.next = newNode; //mutGenLimit 1
