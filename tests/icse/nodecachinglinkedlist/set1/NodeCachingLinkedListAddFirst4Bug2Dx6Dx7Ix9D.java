...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst4Bug2Dx6Dx7Ix9D {
    ...
    public NodeCachingLinkedListAddFirst4Bug2Dx6Dx7Ix9D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        newNode.value = firstCachedNode; //mutGenLimit 1
        ...
        insertBeforeNode.next = newNode; //mutGenLimit 1
        this.size++; //mutGenLimit 0
        this.modCount = this.cacheSize + 1; //mutGenLimit 1
