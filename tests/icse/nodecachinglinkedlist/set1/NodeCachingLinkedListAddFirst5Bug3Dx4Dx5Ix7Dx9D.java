...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst5Bug3Dx4Dx5Ix7Dx9D {
    ...
    public NodeCachingLinkedListAddFirst5Bug3Dx4Dx5Ix7Dx9D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        ...
        icse.nodecachinglinkedlist.LinkedListNode insertBeforeNode = this.firstCachedNode.next; //mutGenLimit 1
        newNode.next = insertBeforeNode.previous; //mutGenLimit 1
        this.header.previous = insertBeforeNode.previous; //mutGenLimit 1
        insertBeforeNode.previous.next = newNode; //mutGenLimit 0
        insertBeforeNode.previous = newNode.next; //mutGenLimit 1
