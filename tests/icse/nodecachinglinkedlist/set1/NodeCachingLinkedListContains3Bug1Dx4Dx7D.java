...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains3Bug1Dx4Dx7D {
    ...
    public NodeCachingLinkedListContains3Bug1Dx4Dx7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != arg) { //mutGenLimit 0
            node = node.previous.next; //mutGenLimit 1
            counter++; //mutGenLimit 0
        }
        if (node != header && node.value == null) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
