...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug1Dx2Dx4Ix7D {
    ...
    public NodeCachingLinkedListContains4Bug1Dx2Dx4Ix7D() {
    ...
    public boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        icse.nodecachinglinkedlist.LinkedListNode node = this.header.next.previous; //mutGenLimit 1
        int counter = this.size; //mutGenLimit 1
        ...
        if (node != header && node.value == new java.lang.Boolean( false )) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
