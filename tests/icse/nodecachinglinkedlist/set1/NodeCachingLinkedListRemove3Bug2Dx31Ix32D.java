...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove3Bug2Dx31Ix32D {
    ...
    public NodeCachingLinkedListRemove3Bug2Dx31Ix32D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        this.maximumCacheSize = this.modCount + 1; //mutGenLimit 1
