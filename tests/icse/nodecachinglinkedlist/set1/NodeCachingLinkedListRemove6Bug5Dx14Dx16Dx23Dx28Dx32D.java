...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug5Dx14Dx16Dx23Dx28Dx32D {
    ...
    public NodeCachingLinkedListRemove6Bug5Dx14Dx16Dx23Dx28Dx32D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        node.previous.next = node; //mutGenLimit 1
        ...
        if (this.DEFAULT_MAXIMUM_CACHE_SIZE < this.maximumCacheSize) { //mutGenLimit 1
