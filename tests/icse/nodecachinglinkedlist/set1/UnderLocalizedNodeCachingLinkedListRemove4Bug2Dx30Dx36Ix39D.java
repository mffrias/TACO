...
* @j2daType
*//*@ nullable_by_default @*/
public class UnderLocalizedNodeCachingLinkedListRemove4Bug2Dx30Dx36Ix39D {
    ...
    public UnderLocalizedNodeCachingLinkedListRemove4Bug2Dx30Dx36Ix39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node = nextCachedNode; //mutGenLimit 0
            node.value = null; //mutGenLimit 0
            this.firstCachedNode = node; //mutGenLimit 0
            this.cacheSize = this.modCount + 1; //mutGenLimit 1
        }
