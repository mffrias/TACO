...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst3Bug3Dx6Ix9D {
    ...
    public NodeCachingLinkedListAddFirst3Bug3Dx6Ix9D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        ...
        icse.nodecachinglinkedlist.LinkedListNode insertBeforeNode = header.next; //mutGenLimit 1
        ...
        modCount = this.cacheSize + 1; //mutGenLimit 1
