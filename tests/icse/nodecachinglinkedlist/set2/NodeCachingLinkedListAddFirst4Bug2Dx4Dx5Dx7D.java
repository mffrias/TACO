...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst4Bug2Dx4Dx5Dx7D {
    ...
    public NodeCachingLinkedListAddFirst4Bug2Dx4Dx5Dx7D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        ...
        newNode.next = this.header; //mutGenLimit 1
        newNode.previous = insertBeforeNode.next.previous; //mutGenLimit 1
        insertBeforeNode.previous.next = newNode; //mutGenLimit 0
        insertBeforeNode.previous = null; //mutGenLimit 1
