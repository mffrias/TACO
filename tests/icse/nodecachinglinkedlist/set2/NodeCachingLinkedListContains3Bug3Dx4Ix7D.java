...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains3Bug3Dx4Ix7D {
    ...
    public NodeCachingLinkedListContains3Bug3Dx4Ix7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (null != header && node.value != arg) { //mutGenLimit 1
            node.previous = node.next; //mutGenLimit 1
            counter++; //mutGenLimit 0
        }
        if (node != header && node.value == new java.lang.Integer( this.maximumCacheSize )) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
