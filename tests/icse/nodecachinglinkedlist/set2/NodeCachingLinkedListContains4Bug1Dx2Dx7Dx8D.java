...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug1Dx2Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains4Bug1Dx2Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        icse.nodecachinglinkedlist.LinkedListNode node = header.previous; //mutGenLimit 1
        int counter = 1; //mutGenLimit 1
        //@decreasing size - counter;
        while (node != header && node.value != arg) { //mutGenLimit 0
            node = node.next; //mutGenLimit 0
            counter++; //mutGenLimit 0
        }
        if (node != header && node.value == new java.lang.Integer( 1 )) { //mutGenLimit 1
