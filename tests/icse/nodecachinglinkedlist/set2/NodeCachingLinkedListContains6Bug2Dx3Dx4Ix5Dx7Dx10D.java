...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains6Bug2Dx3Dx4Ix5Dx7Dx10D {
    ...
    public NodeCachingLinkedListContains6Bug2Dx3Dx4Ix5Dx7Dx10D() {
    ...
    public boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node == header && node.value != arg) { //mutGenLimit 1
            ...
            counter = this.maximumCacheSize + 1; //mutGenLimit 1
        }
