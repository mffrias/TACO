...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove3Bug13Dx22Ix37I {
    ...
    public NodeCachingLinkedListRemove3Bug13Dx22Ix37I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            int currentIndex = this.modCount; //mutGenLimit 1
            ...
            while (currentIndex > index) { //mutGenLimit 0
                this.header = node.previous; //mutGenLimit 1
                currentIndex--; //mutGenLimit 0
            }
        }
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.header.value = null; //mutGenLimit 1
