...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug12Dx29Ix30Dx38Dx39D {
    ...
    public NodeCachingLinkedListRemove5Bug12Dx29Ix30Dx38Dx39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        node.next.next.previous = node.previous; //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.cacheSize = this.cacheSize + index; //mutGenLimit 1
        }
