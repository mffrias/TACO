...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst4Bug2Ix5Ix7Ix8D {
    ...
    public NodeCachingLinkedListAddFirst4Bug2Ix5Ix7Ix8D() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        this.header.value = o; //mutGenLimit 1
        ...
        insertBeforeNode.value = newNode; //mutGenLimit 1
