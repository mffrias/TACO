...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug1Dx3Dx4Dx5D {
    ...
    public NodeCachingLinkedListContains4Bug1Dx3Dx4Dx5D() {
    ...
    public boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node.previous != header && node.value != arg) { //mutGenLimit 1
            node = this.firstCachedNode.next; //mutGenLimit 1
