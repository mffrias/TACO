...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug1Dx3Dx4Dx5Dx7D {
    ...
    public NodeCachingLinkedListContains5Bug1Dx3Dx4Dx5Dx7D() {
    ...
    public boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value == arg) { //mutGenLimit 1
            ...
            counter = this.cacheSize + 1; //mutGenLimit 1
        }
