...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug8Dx14Dx21Dx30D {
    ...
    public NodeCachingLinkedListRemove4Bug8Dx14Dx21Dx30D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.DEFAULT_MAXIMUM_CACHE_SIZE > this.size) { //mutGenLimit 1
