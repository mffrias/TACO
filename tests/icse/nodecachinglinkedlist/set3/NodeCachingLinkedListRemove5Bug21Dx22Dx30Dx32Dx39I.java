...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug21Dx22Dx30Dx32Dx39I {
    ...
    public NodeCachingLinkedListRemove5Bug21Dx22Dx30Dx32Dx39I() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (this.maximumCacheSize > index) { //mutGenLimit 1
        ...
        if (!(this.cacheSize < this.maximumCacheSize)) { //mutGenLimit 1
            ...
            this.maximumCacheSize = this.cacheSize + 1; //mutGenLimit 1
        }
