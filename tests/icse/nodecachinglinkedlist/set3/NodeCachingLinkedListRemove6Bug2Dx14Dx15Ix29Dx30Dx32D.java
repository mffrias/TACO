...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug2Dx14Dx15Ix29Dx30Dx32D {
    ...
    public NodeCachingLinkedListRemove6Bug2Dx14Dx15Ix29Dx30Dx32D() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (currentIndex < this.modCount) { //mutGenLimit 1
                this.header = node.next; //mutGenLimit 1
