...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst3Bug2Dx4Ix6I {
    ...
    public NodeCachingLinkedListAddFirst3Bug2Dx4Ix6I() {
    ...
    public boolean addFirst( java.lang.Object o, LinkedListNode newNode ) {
        newNode.value = new java.lang.Integer( this.size ); //mutGenLimit 1
