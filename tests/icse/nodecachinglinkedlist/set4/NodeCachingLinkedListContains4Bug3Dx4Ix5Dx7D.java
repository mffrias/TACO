...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug3Dx4Ix5Dx7D {
    ...
    public NodeCachingLinkedListContains4Bug3Dx4Ix5Dx7D() {
    ...
    public boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != node) { //mutGenLimit 1
            node.next = node.next; //mutGenLimit 1
            this.modCount++; //mutGenLimit 1
        }
        if (this.firstCachedNode != header && node.value == arg) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
