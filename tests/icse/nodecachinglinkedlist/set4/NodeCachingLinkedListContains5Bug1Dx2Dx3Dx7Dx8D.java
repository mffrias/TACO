...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug1Dx2Dx3Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains5Bug1Dx2Dx3Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        icse.nodecachinglinkedlist.LinkedListNode node = this.header.next.next; //mutGenLimit 1
        int counter = this.maximumCacheSize; //mutGenLimit 1
        //@decreasing size - counter;
        while (node != header && node.previous.value != arg) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
            counter++; //mutGenLimit 0
        }
        if (node != header && node.value == new java.lang.Integer( 0 )) { //mutGenLimit 1
