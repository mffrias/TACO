...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug8Dx15Ix22Dx41D {
    ...
    public NodeCachingLinkedListRemove4Bug8Dx15Ix22Dx41D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (currentIndex < index) { //mutGenLimit 0
                node.value = node.next; //mutGenLimit 1
            ...
            while (currentIndex > index) { //mutGenLimit 0
                node = this.firstCachedNode.previous; //mutGenLimit 1
                currentIndex--; //mutGenLimit 0
            }
        }
        ...
        return new java.lang.Integer( this.modCount ); //mutGenLimit 1
    }
