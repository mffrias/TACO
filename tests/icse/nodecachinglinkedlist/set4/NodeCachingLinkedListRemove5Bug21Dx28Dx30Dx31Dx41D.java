...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug21Dx28Dx30Dx31Dx41D {
    ...
    public NodeCachingLinkedListRemove5Bug21Dx28Dx30Dx31Dx41D() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        node.previous.next = this.firstCachedNode.next; //mutGenLimit 1
        node.next.previous = node.previous; //mutGenLimit 0
        this.size = this.size - 0; //mutGenLimit 1
        this.modCount = this.modCount + this.cacheSize; //mutGenLimit 1
