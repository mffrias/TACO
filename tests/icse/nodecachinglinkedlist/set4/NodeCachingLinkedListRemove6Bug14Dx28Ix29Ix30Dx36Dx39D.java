...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug14Dx28Ix29Ix30Dx36Dx39D {
    ...
    public NodeCachingLinkedListRemove6Bug14Dx28Ix29Ix30Dx36Dx39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (currentIndex < this.size) { //mutGenLimit 1
