...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains2Bug3Dx7D {
    ...
    public NodeCachingLinkedListContains2Bug3Dx7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != this.header.next && node.value != arg) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
            counter++; //mutGenLimit 0
        }
        if (node != this.firstCachedNode && node.value == arg) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
