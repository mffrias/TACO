...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug1Dx3Dx4Ix7D {
    ...
    public NodeCachingLinkedListContains4Bug1Dx3Dx4Ix7D() {
    ...
    public boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        if (null != header && node.value == arg) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
