...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove2Bug11Dx30D {
    ...
    public NodeCachingLinkedListRemove2Bug11Dx30D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.DEFAULT_MAXIMUM_CACHE_SIZE / 2) { //mutGenLimit 1
