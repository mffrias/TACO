...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove3Bug19Dx30Dx36I {
    ...
    public NodeCachingLinkedListRemove3Bug19Dx30Dx36I() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            nextCachedNode.next = nextCachedNode; //mutGenLimit 1
