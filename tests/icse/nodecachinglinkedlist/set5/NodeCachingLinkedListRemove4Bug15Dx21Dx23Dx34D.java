...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug15Dx21Dx23Dx34D {
    ...
    public NodeCachingLinkedListRemove4Bug15Dx21Dx23Dx34D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            nextCachedNode = this.header; //mutGenLimit 1
