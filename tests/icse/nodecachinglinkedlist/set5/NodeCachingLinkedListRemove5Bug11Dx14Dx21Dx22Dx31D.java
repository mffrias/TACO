...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug11Dx14Dx21Dx22Dx31D {
    ...
    public NodeCachingLinkedListRemove5Bug11Dx14Dx21Dx22Dx31D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / this.DEFAULT_MAXIMUM_CACHE_SIZE) { //mutGenLimit 1
            node = this.header.next; //mutGenLimit 0
            int currentIndex = 0; //mutGenLimit 0
            //@decreasing index - currentIndex;
            while (this.modCount < index) { //mutGenLimit 1
            ...
            while (currentIndex++ > index) { //mutGenLimit 1
                node = node.next.previous; //mutGenLimit 1
                currentIndex--; //mutGenLimit 0
            }
        }
        ...
        this.modCount = this.modCount + 0; //mutGenLimit 1
