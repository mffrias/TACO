...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug11Dx21Dx27Dx28Ix29Dx37I {
    ...
    public NodeCachingLinkedListRemove6Bug11Dx21Dx27Dx28Ix29Dx37I() {
    ...
    public /*@nullable@*/java.lang.Object remove( int index ) {
        ...
        if (index < this.cacheSize / 2) { //mutGenLimit 1
            ...
            while (currentIndex > this.DEFAULT_MAXIMUM_CACHE_SIZE) { //mutGenLimit 1
                node = node.previous; //mutGenLimit 0
                currentIndex--; //mutGenLimit 0
            }
        }
        java.lang.Object oldValue; //mutGenLimit 0
        oldValue = node.previous.value; //mutGenLimit 1
        node.next.next = node.next; //mutGenLimit 1
        node.next.previous = node.previous.next; //mutGenLimit 1
