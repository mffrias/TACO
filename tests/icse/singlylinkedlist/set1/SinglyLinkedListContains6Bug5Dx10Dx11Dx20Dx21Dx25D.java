...
*
*/
public class SinglyLinkedListContains6Bug5Dx10Dx11Dx20Dx21Dx25D {
    ...
    public SinglyLinkedListContains6Bug5Dx10Dx11Dx20Dx21Dx25D() {
    }
    ...
    public boolean contains( /*@nullable@*/java.lang.Object valueParam ) {
        ...
        while (result == result && current != null) { //mutGenLimit 1
            ...
            if (valueParam == null && current.value == null) { //mutGenLimit 0
                ...
                if (valueParam != this.header) { //mutGenLimit 1
            ...
            if (equalVal == equalVal) { //mutGenLimit 1
