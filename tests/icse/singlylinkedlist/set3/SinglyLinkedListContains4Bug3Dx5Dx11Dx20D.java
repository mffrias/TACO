...
*
*/
public class SinglyLinkedListContains4Bug3Dx5Dx11Dx20D {
    ...
    public SinglyLinkedListContains4Bug3Dx5Dx11Dx20D() {
    }
        ...
        while (!(result == false) && current != null) { //mutGenLimit 1
            ...
            if (valueParam == null && current.value == null) { //mutGenLimit 0
                ...
                if (valueParam != null) { //mutGenLimit 0
                    if (new Boolean(false) == current.value) { //mutGenLimit 1
                        equalVal = true; //mutGenLimit 0
                    } else {
