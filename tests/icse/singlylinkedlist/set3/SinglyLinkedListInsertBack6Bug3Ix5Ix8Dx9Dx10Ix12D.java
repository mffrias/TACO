...
*
*/
public class SinglyLinkedListInsertBack6Bug3Ix5Ix8Dx9Dx10Ix12D {
    ...
    public SinglyLinkedListInsertBack6Bug3Ix5Ix8Dx9Dx10Ix12D() {
    }
    ...
    public void insertBack( java.lang.Object arg,  SinglyLinkedListNode freshNode) {
        ...
        freshNode.next.value = null; //mutGenLimit 1
        if (this.header == null) { //mutGenLimit 0
            header = freshNode; //mutGenLimit 1
        } else {
