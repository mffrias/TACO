...
*
*/
public class SinglyLinkedListContains4Bug4Dx5Dx10Dx20D {
    ...
    public SinglyLinkedListContains4Bug4Dx5Dx10Dx20D() {
    }
    ...
    public boolean contains( /*@nullable@*/java.lang.Object valueParam ) {
        ...
        while (!(result == false) && current != null) { //mutGenLimit 1
            ...
            if (valueParam == null && current.value == null) { //mutGenLimit 0
                ...
                if (valueParam != new Integer(1)) { //mutGenLimit 1
            ...
            if (equalVal == result) { //mutGenLimit 1
