...
*
*/
public class SinglyLinkedListContains6Bug5Dx7Dx8Dx11Dx21Dx25D {
    ...
    public SinglyLinkedListContains6Bug5Dx7Dx8Dx11Dx21Dx25D() {
    }
    ...
    public boolean contains( /*@nullable@*/java.lang.Object valueParam ) {
        ...
        while (result == true && current != null) { //mutGenLimit 1
            boolean equalVal;
            if (valueParam == null && current.value != null) { //mutGenLimit 1
                equalVal = false; //mutGenLimit 1
            } else {
                if (valueParam != null) { //mutGenLimit 0
                    if (valueParam == this.header.value) { //mutGenLimit 1
