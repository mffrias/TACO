...
*
*/
public class SinglyLinkedListContains4Bug3Dx7Dx10Dx21D {
    ...
    public SinglyLinkedListContains4Bug3Dx7Dx10Dx21D() {
    }
    ...
    public boolean contains( /*@nullable@*/java.lang.Object valueParam ) {
        ...
        while (result == false && current != null) { //mutGenLimit 0
            boolean equalVal;
            if (valueParam == null && current.value == header) { //mutGenLimit 1
