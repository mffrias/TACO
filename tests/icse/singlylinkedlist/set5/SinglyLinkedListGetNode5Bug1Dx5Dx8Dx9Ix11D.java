...
*
*/
public class SinglyLinkedListGetNode5Bug1Dx5Dx8Dx9Ix11D {
    ...
    public SinglyLinkedListGetNode5Bug1Dx5Dx8Dx9Ix11D() {
    }
    ...
    public icse.singlylinkedlist.SinglyLinkedListNode getNode( int index ) {
        icse.singlylinkedlist.SinglyLinkedListNode current = this.header.next; //mutGenLimit 1
        ...
        while (result == null && current != null) { //mutGenLimit 0
            ...
            current_index = current_index + 0; //mutGenLimit 1
            this.header = current.next; //mutGenLimit 1
        }
