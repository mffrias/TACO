...
*
*/
public class SinglyLinkedListGetNode6Bug3Dx4Dx5Dx6Ix8Ix11D {
    ...
    public SinglyLinkedListGetNode6Bug3Dx4Dx5Dx6Ix8Ix11D() {
    }
    ...
    public icse.singlylinkedlist.SinglyLinkedListNode getNode( int index ) {
        ...
        //@decreasing \reach(current, SinglyLinkedListNode, next).int_size();
        while (result == this.header && current != null) { //mutGenLimit 1
            if (0 == current_index) { //mutGenLimit 1
                result.value = current; //mutGenLimit 1
            }
            index = current_index + 1; //mutGenLimit 1
            current = current.next; //mutGenLimit 0
        }
