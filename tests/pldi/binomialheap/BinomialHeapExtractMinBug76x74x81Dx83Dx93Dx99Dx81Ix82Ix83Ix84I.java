...
public class BinomialHeapExtractMinBug76x74x81Dx83Dx93Dx99Dx81Ix82Ix83Ix84I {
    ...
    public BinomialHeapExtractMinBug76x74x81Dx83Dx93Dx99Dx81Ix82Ix83Ix84I () {
    }
                    ...
                    while (nextTemp != null) {
                        if ((tempUnionNodes.degree == nextTemp.degree) || ((nextTemp.sibling != null) && (nextTemp.sibling.degree == tempUnionNodes.degree))) { //mutGenLimit 1
                            ...
                            if (tempUnionNodes.key <= nextTemp.key) {
                            	...
                            	nextTemp.parent.sibling = tempUnionNodes.child.parent; //mutGenLimit 2
                            	tempUnionNodes.findMinNode().child = nextTemp; //mutGenLimit 1
