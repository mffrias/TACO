...
public class BinomialHeapInsertBug50x33x48x55Dx57Dx67Dx73Dx55Ix56Ix57I {
    ...
    public BinomialHeapInsertBug50x33x48x55Dx57Dx67Dx73Dx55Ix56Ix57I () {
    }
                ...
                while (nextTemp != null) { 
                    if ((temp.degree == nextTemp.degree) || ((nextTemp.sibling != null) && (nextTemp.sibling.degree == temp.degree))) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { 
                        	...
                        	nextTemp.sibling.sibling = temp.child.findMinNode(); //mutGenLimit 2
                            temp.child = nextTemp; 
                            temp.degree++; 
                        } else {
                            if (prevTemp == null) { 
