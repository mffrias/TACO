...
/**
 * @j2daType
 *//*@ nullable_by_default @*/public class NodeCachingLinkedListAddFirstBug6Ix4Ix5Ix7Ix2Dx5Dx3x6Dx4Dx7D {
    ...
    public NodeCachingLinkedListAddFirstBug6Ix4Ix5Ix7Ix2Dx5Dx3x6Dx4Dx7D() {
...
/*@
	  ...
	  public boolean addFirst( java.lang.Object o ) {
		  ...
		  insertBeforeNode.previous.next = insertBeforeNode.previous; //mutGenLimit 2
		  insertBeforeNode.next.previous = insertBeforeNode.previous.previous; //mutGenLimit 2
		  insertBeforeNode.previous.next.previous = newNode.previous; //mutGenLimit 2
		  insertBeforeNode.previous.value = newNode.next; //mutGenLimit 2
