...
public class SinglyLinkedListInsertBackBug9x12Ix8Ix10Ix3Ix2Dx4x10Dx12Dx5I {

/*@
    @ invariant (\forall SinglyLinkedListNode n; \reach(this.header, SinglyLinkedListNode, next).has(n); \reach(n.next, SinglyLinkedListNode, next).has(n)==false);
    @*/    public /*@nullable@*/roops.core.objects.SinglyLinkedListNode header;

    public SinglyLinkedListInsertBackBug9x12Ix8Ix10Ix3Ix2Dx4x10Dx12Dx5I() {
    }
...
/*@
      ...
      @*/    public void insertBack( java.lang.Object arg ) {
        ...
        if (this.header != null) { //mutGenLimit 1
            this.header.value = freshNode; //mutGenLimit 1
        } else {
            ...
            while (current.next == null) { //mutGenLimit 1
                current.value = current; //mutGenLimit 2
            }
            current.value = current.next; //mutGenLimit 2
        }
    }
