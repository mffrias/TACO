...
public class ForArielGodioAbsoluteBug02Test extends CollectionTestBase {
	...
	protected String getClassToCheck() {
		return "forArielGodio.leapYear.bug02.LeapYear";
	}

	public void test_genericMethod1Test() throws VizException {
		setConfigKeyRelevantClasses("forArielGodio.leapYear.bug02.LeapYear");
		...
		setConfigKeyTypeScopes("forArielGodio.leapYear.bug02.LeapYear:1");
