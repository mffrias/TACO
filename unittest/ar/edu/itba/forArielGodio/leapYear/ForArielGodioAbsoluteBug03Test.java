...
public class ForArielGodioAbsoluteBug03Test extends CollectionTestBase {
	...
	protected String getClassToCheck() {
		return "forArielGodio.leapYear.bug03.LeapYear";
	}

	public void test_genericMethod1Test() throws VizException {
		setConfigKeyRelevantClasses("forArielGodio.leapYear.bug03.LeapYear");
		...
		setConfigKeyTypeScopes("forArielGodio.leapYear.bug03.LeapYear:1");
