...
public class StrykerBinomialHeapUnionNodesRoopsTest extends CollectionTestBase {
    ...
    public void test_unionNodesTest() throws VizException {
        ...
        check(GENERIC_PROPERTIES, "unionNodes_0", true);
    }
