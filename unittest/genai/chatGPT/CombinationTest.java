...
public class CombinationTest  extends CollectionTestBase {

    @Override
    protected String getClassToCheck() {
        return "genai.chatGPT.Combination";
    }

    private void config() throws VizException {
        // To solve imports
        setConfigKeyRelevantClasses("genai.chatGPT.Combination");
        ...
        setConfigKeyTypeScopes("genai.chatGPT.Combination:1");
