...
public class FindInSortedTest  extends CollectionTestBase {
    ...
    protected String getClassToCheck() {
        return "genai.chatGPT.Find_In_Sorted";
    }

    private void config() throws VizException {
        // To solve imports
        setConfigKeyRelevantClasses("genai.chatGPT.Find_In_Sorted");
        ...
        setConfigKeyTypeScopes("genai.chatGPT.Find_In_Sorted:1");
    ...
    public void test_genericMethod2Test() throws VizException {
        config();
        check (GENERIC_PROPERTIES, "binarySearchInRange(int[],int,int,int)", true);
    }
