...
public class BinarySearchTest  extends CollectionTestBase {

    @Override
    protected String getClassToCheck() {
        return "genai.chatGPT.BinarySearch";
    }

    private void config() throws VizException {
        // To solve imports
        setConfigKeyRelevantClasses("genai.chatGPT.BinarySearch");
        ...
        setConfigKeyTypeScopes("genai.chatGPT.BinarySearch:1");
