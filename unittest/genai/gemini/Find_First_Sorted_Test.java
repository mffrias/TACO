...
public class Find_First_Sorted_Test  extends CollectionTestBase {
    ...
    protected String getClassToCheck() {
        return "gemini.Find_First_Sorted";
    }

    private void config() throws VizException {
        // To solve imports
        setConfigKeyRelevantClasses("gemini.Find_First_Sorted");
        ...
        setConfigKeyTypeScopes("gemini.Find_First_Sorted:1");
    ...
    public void test_genericMethod2Test() throws VizException {
        config();
        check (GENERIC_PROPERTIES, "findFirstOccurrence(int[],int)", true);
    }
